export const data = [
  ...
  },
  {
    isTrue: false,
    uid:'Three',
    heading: "Where can an FIR be filed?",
    answer:
  ...
  },
  {
    isTrue: false,
    uid: 'Five',
    heading: "Why should one file an FIR?",
    answer:
  ...
  },
  {
    isTrue: true,
    uid: 'Six',
    heading: "What is the procedure to file an FIR?",
    answer: ` The officer must record the FIR in writing.,
    The officer must read the FIR back to the person filing the FIR to ensure that all details are correct.,
    The person filing the FIR must sign the FIR.,
  ...
  },
  {
    isTrue: true,
    uid: 'Seven',
    heading: "What about after the FIR has been filed?",
    answer: `Once an FIR has been filed the police are legally obligated to start investigating the case. The process of investigation includes, but is not limited to, collecting evidence, questioning witnesses, inspecting the crime scene, recording statements and forensic testing. If the criminals are found, the police will make arrests.,
  ...
  },
  {
    isTrue: true,
    uid: 'Eight',
    heading: "What can you do if your FIR is not registered?",
    answer: `You can meet the Superintendent of Police or other higher officers like Deputy Inspector General of Police and Inspector General of Police and bring your complaint to their notice.,
  ...
  },
  {
    isTrue: false,
    uid: 'Nine',
    heading: `Are there alternate steps available to filing an FIR?`,
    answer: `Yes, there are alternate steps to filing an FIR, for women. You can call to the National Commission for Women (ideal if there is a refusal to file an FIR)`,
    points: [],
  },
  {
    isTrue: true,
    uid: 'Ten',
    heading: `What are the actions taken by the NCW on receipt of complaints?`,
    answer: `Counselling: Counselling services are provided to the aggrieved and she would be told about the status of law and various options available to her.
